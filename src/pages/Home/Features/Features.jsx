    ...
    return (
        <div className="my-con">
            <div className="">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 px-12 gap-6 sm:px-6 md:px-10 sm:gap-5 md:gap-x-8 lg:px-0 md:gap-y-8 lg:gap-x-8">
                    {
