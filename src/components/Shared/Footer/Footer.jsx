...
const Footer = () => {
    return (
        <div className=" pt-10 pb-6 px-2 lg:pt-20 lg:pb-10 xl:pt-24 xl:pb-14 bg-[#DFF4FF]">
            <div className="grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-x-12 lg:gap-x-1 xl:gap-x-12 gap-y-4 my-con">
                ...
                <div>
                    <Logo></Logo>
                    <p className="pt-4 pb-5 text-[#2D5C94] text-lg">Japanese hospitality for you in real estate business</p>
