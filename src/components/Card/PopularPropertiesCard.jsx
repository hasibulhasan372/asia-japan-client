        ...
        <div className="border border-[#F9EDED] rounded-[10px]  pb-[27px]">
            ...
            <div className="pl-5">
                ...
                <div className='flex gap-x-2'>
                    <p className="property-feature"><FaHouse className='text-base'></FaHouse>{asset}</p>
                    <p className='property-feature'><BiSolidArea className='text-base'></BiSolidArea>{size}</p>
                    <p className='property-feature'><TbCurrencyTaka className='rounded border bg-[#011E40] text-white text-base'></TbCurrencyTaka>{price}</p>
                </div>
                <div className='space-x-2 mt-[20px] lg:mt-[30px]'>
